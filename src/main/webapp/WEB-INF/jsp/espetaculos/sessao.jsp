...
<html>
	...
	<body>
		...
		<p id="preco"><span class="label">Preco:</span> <fmt:formatNumber type="currency" value="${sessao.preco}" /></p>
		<p><span class="label">Ingressos disponíveis:</span> ${sessao.ingressosDisponiveis }</p>
					
		<c:if test="${sessao.ingressosDisponiveis gt 0}">
			<form id="reservaIngresso" action="/sessao/${sessao.id}/reserva" method="post">
				<h3>Reservar ingresso</h3>
				<label for="desc">Estudante / Idoso:</label> 
